...
cardiac_dataset = anatomy_data('data/cardiac/cardiac_singlecoil_train.mat', acc=acc, n=40, mask=mask)
...
save_dir = f"universal_LDA/cardiac/checkpoints_transfer_{acc}_sampling_{mask}_init_3"
