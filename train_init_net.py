...
for epoch_i in range(1, n_epoch+1):
    for i, (data1, data2, data3, data4, data5) in enumerate(zip(anatomy_loader1, anatomy_loader2, anatomy_loader3, anatomy_loader4, anatomy_loader5)):
        ...
        _, k_und1, mask1, _, k_gnd1 = data1
        _, k_und2, mask2, _, k_gnd2 = data2
        _, k_und3, mask3, _, k_gnd3 = data3
        _, k_und4, mask4, _, k_gnd4 = data4
        _, k_und5, mask5, _, k_gnd5 = data5
        ...
        mask1, mask2, mask3, mask4, mask5 = mask1.to(device), mask2.to(device), mask3.to(device), mask4.to(device), mask5.to(device)
        #mask = mask.to(device)
