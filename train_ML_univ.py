...
from utils.model import ML_Universal_LDA#Universal_LDA
...
model = ML_Universal_LDA(n_block=n_phase, anatomies=anatomies, channel_num=16)
...
save_dir = f"universal_LDA/ML_universal/checkpoints_{acc}_sampling_{mask}"
