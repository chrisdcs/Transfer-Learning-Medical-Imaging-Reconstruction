...
model.load_state_dict(torch.load('universal_LDA/universal/checkpoints_sampling/checkpoint.pth')['state_dict'],
                      strict=False)

# freeze the weights of the pretrained anatomy-specific layers
for name, param in model.named_parameters():
    if sampling_rates[0] in name or sampling_rates[1] in name or 'ImgNet' in name:
...
dataset = anatomy_data('data/brain/brain_singlecoil_train.mat', acc=10, n=40)
...
save_dir = "universal_LDA/brain_sampling/checkpoints_universal"
